...
//            Ciudad CiudadJuego = DecC.getCartas().get(ran);
            ...
            CiudadPrueba.setLongitud(-0.118092);
            CiudadPrueba.setName("London");
            ...
            for(i = 0;i < 1000;i+=60){
                Place p = new Place();
                p.setLatitud(CiudadPrueba.getLatitud()+i/genRandom(10,50));
                p.setLongitud(CiudadPrueba.getLongitud()+i/genRandom(10,50));
                p.setName("Nombre");
                p.setTipo(Type.park);
                p.setValor(5);
                po.add(p);
            ...
            CiudadPrueba.setPlaces(po);
            
            
            Grafo = new Graph(CiudadPrueba.getPlaces().size());
            genGrafo(CiudadPrueba);
        ...
        public void genGrafo(Ciudad CiudadJuego){
            ...
            while(indexP < CiudadJuego.getPlaces().size() - 1){
                ...
                while(indexP2 < CiudadJuego.getPlaces().size() - 1){
                    ...
                    distanciaEntrePlace = GeoMap.distance(P.getLatitud(),P.getLongitud(),P2.getLatitud(),P2.getLongitud()); 
